...
<table class="generalIndexTable" style="padding-top:50px;">
	<tr>
		<td width=60% valign='top'>
			<openmrs:portlet id="findPatient" url="findPatient" parameters="size=full|postURL=${baseUrl}/module/pihrwanda/apps/oncology/patientDashboard.form|showIncludeVoided=false|hideAddNewPatient=true|viewType=shortEdit" />
